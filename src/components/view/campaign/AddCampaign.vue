                            ...
                            <form action="" @submit.prevent="addCampaign()" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12 p-0">
                                    <div class="form-group col-md-6 p-0" style="float:left">
                                        ...
                                        <input  type="text" v-model="form.start_date" class="form-control input-date"  placeholder="yyyy-mm-dd">
                                    </div>
                                    <div class="form-group col-md-6 p-0" style="float:left">
                                        <label for="end-date">End date</label>
                                        <input type="text" v-model="form.end_date"  class="form-control input-date" placeholder="yyyy-mm-dd">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="type" name="status" class="form-control input-" v-model="form.status">
                                        <option>Chose..</option>
